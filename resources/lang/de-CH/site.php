...
return [
    ...
    'homepage' => [
        ...
        'physio-summary' => 'Die Freude an der Bewegung ist in jedem Kind angelegt. Mein Ziel ist es, diese Freude auch bei den Kindern zu wecken welche keine optimalen Startbedingungen haben',
        'practice-summary' => 'Persönlichkeiten die sich ergänzen, eine warme Atmosphäre,  ihr Startpunkt für eine Veränderung',
        'courses-summary' => 'Im atelier dynamis bieten wir Kurse für die Kleinsten an'
    ],
    'physio-page' => [
        'name' => 'Kinderphysiotherapie',
        'offer-title' => 'Angebot',
        'patient-care-title' => 'Behandlungsindikationen',
    ...
    'practice-page' => [
        ...
        'sarah-formation2' => [
            ...
            'content' => 'Pädiatrie für Craniosacraltherapeuten{0}Schröpfen{0}Viszerale Dynamiken 1&2, Behandlung der inneren Organe{0}Der innere Behandlungsplan{0}Traumaheilung rund um Schwangerschaft, Geburt und Bindung{0}Branchenzertifikat OdAKomplementärtherapie',
        ],
        'sarah-formation3' => [
        ...
        'sophie-formation2' => [
            'title' => 'Atemphysiotherapie',
            'content' => 'Postiaux (Auskultation){0}Chevaillier (Autogene Drainage){0}Umgang mit Asthma',
        ],
        'sophie-formation3' => [
            'title' => 'Orthopädie',
            'content' => 'Verschiedene Kurse über Fehlbildungen der Füsse{0}Muskuloskelettale Rehabilitation beim Kind{0}Behandlung von Blockaden der Schädelbasis und der Wirbelsäule beim Baby und Kleinkind (KISS Syndrome)',
        ],
        'sophie-formation4' => [
    ...
    'courses-page' => [
        ...
        'course1-schedule' => 'Montag 16-17Uhr{0}Einstieg jederzeit möglich wenn es freie Plätze gibt',
        ...
        'course2-schedule' => 'Freitag 16-17Uhr{0}Einstieg jederzeit möglich, wenn es freie Plätze gibt.',
